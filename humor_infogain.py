...
decompose("preds/ranking_qwen2_5_7b_thinking.json")
print("------------------------Non sft decompose ended-----------------------------------")
decompose("preds/ranking_qwen2_5_7b_300steps.json")
print("------------------------300 steps decompose ended----------------------------------")
decompose("preds/ranking_qwen2_5_7b_750steps.json")
print("------------------------750 steps decompose ended----------------------------------")